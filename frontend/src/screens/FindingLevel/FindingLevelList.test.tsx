...
import { FindingLevelList } from './FindingLevelList';
...
describe('FindingLevelList', () => {
  it('should render without crashing', () => {
    const { container } = render(<FindingLevelList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<FindingLevelList />, { wrapper });
    expect(screen.getByText('FindingLevel')).toBeDefined();
  });

  it('should have create button', () => {
    render(<FindingLevelList />, { wrapper });
    expect(screen.getByText('+ Create FindingLevel')).toBeDefined();
  });
