...
import { RequirementReferenceList } from './RequirementReferenceList';
...
describe('RequirementReferenceList', () => {
  it('should render without crashing', () => {
    const { container } = render(<RequirementReferenceList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<RequirementReferenceList />, { wrapper });
    expect(screen.getByText('RequirementReference')).toBeDefined();
  });

  it('should have create button', () => {
    render(<RequirementReferenceList />, { wrapper });
    expect(screen.getByText('+ Create RequirementReference')).toBeDefined();
  });
