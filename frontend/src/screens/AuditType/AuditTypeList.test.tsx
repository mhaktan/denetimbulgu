...
describe('AuditTypeList', () => {
  it('should render without crashing', () => {
    const { container } = render(<AuditTypeList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<AuditTypeList />, { wrapper });
    expect(screen.getByText('AuditType')).toBeDefined();
  });

  it('should have create button', () => {
    render(<AuditTypeList />, { wrapper });
    expect(screen.getByText('+ Create AuditType')).toBeDefined();
  });
