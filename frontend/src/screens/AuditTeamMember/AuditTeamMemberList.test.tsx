...
import { AuditTeamMemberList } from './AuditTeamMemberList';
...
describe('AuditTeamMemberList', () => {
  it('should render without crashing', () => {
    const { container } = render(<AuditTeamMemberList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<AuditTeamMemberList />, { wrapper });
    expect(screen.getByText('AuditTeamMember')).toBeDefined();
  });

  it('should have create button', () => {
    render(<AuditTeamMemberList />, { wrapper });
    expect(screen.getByText('+ Create AuditTeamMember')).toBeDefined();
  });
