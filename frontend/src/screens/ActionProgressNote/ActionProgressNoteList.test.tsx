...
import { ActionProgressNoteList } from './ActionProgressNoteList';
...
describe('ActionProgressNoteList', () => {
  it('should render without crashing', () => {
    const { container } = render(<ActionProgressNoteList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<ActionProgressNoteList />, { wrapper });
    expect(screen.getByText('ActionProgressNote')).toBeDefined();
  });

  it('should have create button', () => {
    render(<ActionProgressNoteList />, { wrapper });
    expect(screen.getByText('+ Create ActionProgressNote')).toBeDefined();
  });
