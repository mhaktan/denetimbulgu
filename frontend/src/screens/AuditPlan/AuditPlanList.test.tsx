...
import { AuditPlanList } from './AuditPlanList';
...
describe('AuditPlanList', () => {
  it('should render without crashing', () => {
    const { container } = render(<AuditPlanList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<AuditPlanList />, { wrapper });
    expect(screen.getByText('AuditPlan')).toBeDefined();
  });

  it('should have create button', () => {
    render(<AuditPlanList />, { wrapper });
    expect(screen.getByText('+ Create AuditPlan')).toBeDefined();
  });
