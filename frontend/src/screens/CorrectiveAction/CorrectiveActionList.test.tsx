...
describe('CorrectiveActionList', () => {
  it('should render without crashing', () => {
    const { container } = render(<CorrectiveActionList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<CorrectiveActionList />, { wrapper });
    expect(screen.getByText('CorrectiveAction')).toBeDefined();
  });

  it('should have create button', () => {
    render(<CorrectiveActionList />, { wrapper });
    expect(screen.getByText('+ Create CorrectiveAction')).toBeDefined();
  });
