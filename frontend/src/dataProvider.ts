...
const RESOURCE_CONFIG: Record<string, ResourceConfig> = {
  ...
  'AuditType': { path: 'api/services/app/AuditType', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'FindingLevel': { path: 'api/services/app/FindingLevel', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'RequirementReference': { path: 'api/services/app/RequirementReference', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'AuditPlan': { path: 'api/services/app/AuditPlan', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'Audit': { path: 'api/services/app/Audit', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'AuditTeamMember': { path: 'api/services/app/AuditTeamMember', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'Finding': { path: 'api/services/app/Finding', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'CorrectiveAction': { path: 'api/services/app/CorrectiveAction', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'ActionProgressNote': { path: 'api/services/app/ActionProgressNote', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'Evidence': { path: 'api/services/app/Evidence', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
