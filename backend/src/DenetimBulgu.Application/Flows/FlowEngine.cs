                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = System.Type.GetType("DenetimBulgu.Approvals.IApprovalAppService, DenetimBulgu.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in DenetimBulgu.Application assembly");
                            ...
                            var submitInputType = System.Type.GetType("DenetimBulgu.Approvals.Dto.SubmitApprovalInput, DenetimBulgu.Application")!;
