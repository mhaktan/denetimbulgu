...
{
    public class DenetimBulguCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = string.IsNullOrEmpty(envConnStr)
                ? DenetimBulguConsts.ConnectionStringName
                : envConnStr;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DenetimBulguCoreModule).GetAssembly());
        }
    }
}
