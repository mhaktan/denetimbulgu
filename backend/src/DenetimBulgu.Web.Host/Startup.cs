...
namespace DenetimBulgu.Web.Host
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "DenetimBulgu API", Version = "v1" });
            ...
            return services.AddAbp<DenetimBulguWebHostModule>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "DenetimBulgu API V1");
            });
